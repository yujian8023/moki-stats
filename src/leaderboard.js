...
if (mode === '--recent') {
...
} else if (mode === '--recent-finished') {
  const hours = parseInt(args[1]) || 1;
  fetchRecentFinished(hours);
  ...
  console.log('  node src/leaderboard.js --recent-finished [hours] - 抓取最近 N 小时内结束的 leaderboard');
